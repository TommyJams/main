...
<head>
    ...
    function loadframe(a) 
    {
        ...
        else if(a=="tours"){ $("#lefty").load("include/artist_tours.php");}
    }
    function gig(a) 
    {
		$("#loading-indicator").show();
...
<body>
	...
	<div id="main-container">
		...
		<script>
			...
			// toursubmit pop-up
			else if(isset($_SESSION['tourSubmitted']) && $_SESSION['tourSubmitted'] == 1){
			
		//	system.out.println("some");
			
			$_SESSION['tourSubmitted'] = 0;
			
		//	echo ("<script language='javascript'> window.alert('Succesfully Updated'); window.location.href='artist.php'; </script>");
			print("window.alert('Succesfully Updated');");
		...
		<div id="menuFooter" style="background:#000;">
			<ul>
                ...
                <li>
                    <a href="javascript:;" onClick="loadframe('tours');"><h3>Tours</h3></a>
                </li>
                <li>
