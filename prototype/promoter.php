...
<script>
	...
	} else if (a == "bookArtist") {
		$("#lefty").load("include/book_artist.php");
	}
...
<body>
	...
	<div id="main-container">
	    ...
	    else if (isset($_GET["book_artist"])) {
		if ($_POST["book_artist_search_term"]) {
			$_SESSION["book_artist_search_term"] = $_POST["book_artist_search_term"];
		}
		print("$('#lefty').load('include/book_artist.php');");
	    }
      ...
      <div id="menuFooter" style="background:#000;">
        <ul>
          <li>
            <a  href="#LaunchGig" onClick="loadframe('add');return false;"><h3>Launch Gig</h3></a>
          </li>
          <li>
            <a href="#BookArtist" onClick="loadframe('bookArtist');return false;"><h3>Book Artist</h3></a>
          </li>
          <li>
            <a  href="#MyGigs" onClick="loadframe('gigs');return false;"><h3>My Gigs</h3></a>
          </li>
          <li>
            <a href="#Profile" onClick="loadframe('left');return false;"><h3>Profile</h3></a>
          </li>
          <li>
            <a href="#EditProfile" onClick="loadfram();return false;"><h3>Edit Profile</h3></a>
          </li>
        </ul>
      </div>
      <!-- end menu --> 
