...
$fb=$a["fb"];$gplus=$a["gplus"];$twitter=$a["twitter"];$web=$a["web"];
...
$status=$a["status"];$link=$a["link"];$sponser=$a["sponser"];$image=$a["image"];
...
<head>
 ...
 <body>
	...
	elseif(isset($_GET["edited"]) && $_GET["edited"]=="new")
    {
        echo('
                <script type="text/javascript">
                    messageBoxUp("Gig Updated","Gig is Edited Successfully.");
                </script>
            ');
    }
    ?>
    ...
    <div id="messageBox" style="display:none;">
        <a id="msgBoxClose" href="#" onClick="messageBoxClose()">
            <img src="images/close.png" align="right">
        </a>
        <center>
            <h1 id="msgBoxTitle">
                Message Box
			...
			<div id="userStats" class="clearfix">
				...
				<div class="data">
					...
					<div class="socialInfo">
                       ...
                       <? if($promoter==$prolink && $status!=1){ ?>     <a  href="javascript:;" onClick="loadframe('<? echo $link; ?>');"><h3 style="background:#000; color:#FFF;">Edit Gig</h3></a> <? } ?>
						</div>
					</div>
                            ...
                            {                       
                                ...
                                {   ?>
                                    <form  action="dib_action.php"  method="post">
                                        ...
                                        <input id="dibStatusButton" type="submit" value="DIB">
                                    </form>
                                    <?
                                }
                            }
                    ...
                    <div class="boxy" style = "height:auto; margin:20px 0px;">
                        <table width="100%" style="text-align:left;">
                            ...
                            <tr style="color: #000; width:10%" >
                                ...
                                <td style="color: #000; background: #fff; padding:5px;"><?  print ("INR $budget_min - $budget_max"); ?></td>
                            </tr>
                            <?
                            if($sponser)
                            {
                                print("
                                    <tr style='color: #000; width:10%' >
                                        <td style='width:10%; background: #ffcc00;'><h2>Sponsor<h2></td>
                                        <td style='color: #000; background: #fff; padding:5px;'>$sponser</td>
                                    </tr>"
                                );
                            }
                            ?>
