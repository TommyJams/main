	...
	onload=function()
	{
		...
		var leftPositionForRightCommon = 0.88 * totalWidth + 'px';
...
//		document.getElementById('headerBox').style.width  = (totalWidth - mainContainerWidth)/2 - (2 * headerLeftMargin) + 'px';
		document.getElementById('headerBox').style.left   = leftPositionForRightCommon;
//		document.getElementById('headerBox').style.left   = (totalWidth + mainContainerWidth)/2 + 'px';

//                document.getElementsByClassName('right-advertisement-container')[0].style.left = 0.85 * totalWidth + 'px';
                document.getElementsByClassName('right-advertisement-container')[0].style.left = leftPositionForRightCommon;
                document.getElementsByClassName('right-advertisement-container')[0].style.top = 0.25 * totalHeight + 'px';
                /* Right advertisement container is display none by default. We position it correctly and then display it. Otherwise, a jerk is seen on page load, when left and top is applied to it. */
                document.getElementsByClassName('right-advertisement-container')[0].style.display = 'block';
                initAdvertisementCarousel();

		document.getElementById('copyrightContainer').style.left = leftPositionForRightCommon;
