		...
		<div class="boxBody">
			...
			<div id="loginBox" class="parent">
				...
				if(isset($_SESSION["username"]) || isset($_SESSION["username_artist"])) {
					...
					print("<div class='fb-login-button'  fb_only='true' fb_register='true' size='large' onlogin=facebookLoginCallback(); registration-url='http://www.tommyjams.com/prototype/fbconnect.php?registered=no'>
					</div>");
				}
				?>
