...
define('FACEBOOK_APP_ID', '394382993976805');
define('FACEBOOK_SECRET', '836be5a29538f764cd22fa3e72a27809'); 
				...
				<div id="textContainer">
					...
					?>
						<iframe src="https://www.facebook.com/plugins/registration?
									 ...
									 redirect_uri=http://www.tommyjams.com/prototype/fbconnect.php?registered=fbregistered&
									 fb_only=true&
									 fb_register=true&
						...
						if ($_REQUEST) 
						{
							...
							if($response)
							{
								...
								else
								{
									...
									$organization=$response["registration"]["org"];
