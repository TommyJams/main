    ...
    <div id="blanket" style="display:none;                            background-color:#111;
        ...
        <?  if(!isset($_GET["id"]))                 {                 ?>
            <div id="profil" style="display:none;">
				<a id="loginBoxClose" href="#" title="Close" onClick="popup('profil')"> 
                </a>
                <center>
                    <h2> <b> Upload your Profile Picture </b></h2>
                </center>
                <form action="update.php" method="post" enctype="multipart/form-data">
                    <table id="uploadTable" style="margin-top: 30px; width: 100%;">
                        <tbody>
							...
							<tr>
								<td align="center" style="width: 100%;">
									<img src="<? echo'https://graph.facebook.com/'.$username.'/picture'; ?>" style="vertical-align:bottom"><br>
