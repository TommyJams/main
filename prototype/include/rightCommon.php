...
<div class="right-advertisement-container">
    <ul class="right-advertisement-carousel">
								<li>
									<div>
										<a href="http://www.tommyjams.com/blog/above-beyond-bringing-tatw450-to-india" class="preloader overlay-image" rel="gallery-1" onclick="_gaq.push(['trackEvent', 'Right-advertisement', 'Click', 'tatw450']);">
											<img src="../../image/_sample/tatw450.jpg" alt="TommyJams rocks!!" />
										</a>
									</div>
								</li>
								...
								<li>
									<div>
										<a href="../../image/_sample/weekender.jpg" class="preloader overlay-image fancybox-image" rel="gallery-1" onclick="_gaq.push(['trackEvent', 'Right-advertisement', 'Click', 'weekender']);">
											<img src="../../image/_sample/weekender.jpg" alt="tommyJams rocks!!" />
										</a>
									</div>
								</li>
								...
								<li>
									<div>
										<a href="http://www.tommyjams.com/blog/swedish-house-mafia-one-last-tour/" class="preloader overlay-image" rel="gallery-1" onclick="_gaq.push(['trackEvent', 'Right-advertisement', 'Click', 'swedish-house-mafia']);">
											<img src="../../image/_sample/swedishhousemafia.jpg" alt="TommyJams rocks!!" />
										</a>
									</div>
								</li>
								...
								<li>
									<div>
										<a href="http://www.youtube.com/embed/r-aer2QFybc" class="preloader overlay-video fancybox-video-youtube" onclick="_gaq.push(['trackEvent', 'Right-advertisement', 'Click', 'shairnfunc']);">
											<img src="../../image/_sample/shaairnfunc.jpg" alt="TommyJams rocks!!" />
										</a>
									</div>
								</li>
