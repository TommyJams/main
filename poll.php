...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>TommyJams - Dedicate a Song</title>
		...
		<meta property="og:description" content="Tap on a song, fill in your message and submit. The song gets played by the performing artists and it will feature your dedication too!" />
						...
						<form name="voting-form" id="voting-form" action="" method="post" class="clear-fix">
							...
							<div class="clear-fix">
								...
								<p class="subtitle-paragraph margin-top-20 margin-bottom-20 clear-fix">
									...
									Tap on a song, fill the form and submit. The song gets played by the performing artists and it will feature your dedication too!

								</p>

								<div id="voting-form-buttonset">
								
									<?
										$SQLs = "SELECT * FROM `$database`.`songpoll` WHERE gig_id='".$currentGig."' ORDER BY song_id";
										$results = mysql_query($SQLs);
										$i = 0;
										...
										while ($a = mysql_fetch_assoc($results))
										{
											...
											if($i == 1)
												print("<input type='radio' class='voting-form-song' name='voting-form-song' id='voting-form-song$songID' checked='checked' value='$songID'/><label id='voting-form-songlabel' for='voting-form-song$songID'>$songName - $origArtist</label>");
											else
												print("<input type='radio' class='voting-form-song' name='voting-form-song' id='voting-form-song$songID' value='$songID'/><label id='voting-form-songlabel' for='voting-form-song$songID'>$songName - $origArtist</label>");
										}
									?>
								...
								<div id="listContainer" class="clear-fix block box-center">
									...
									<ul class="no-list form-line">
										...
										<li class="clear-fix block">
											<label for="voting-form-dedication">Enter your message</label>
											<input type="text" name="voting-form-dedication" id="voting-form-dedication"/>
										</li>

										<li class="clear-fix block">
											<label for="voting-form-name">Enter your name</label>
											<input type="text" name="voting-form-name" id="voting-form-name"/>
										</li>

										<li class="clear-fix block">
											<label for="voting-form-email">Enter your email</label>
											<input type="text" name="voting-form-email" id="voting-form-email"/>
										</li>

										<li class="clear-fix block">
											<input type="submit" id="voting-form-send" name="voting-form-send" class="button" value="Submit"/>
										</li>
								...
								<p class="subtitle-paragraph margin-top-20 margin-bottom-20 clear-fix">
									...
									<span class = "bold">
										...
										Like us to get access to the latest music news, events, and offers.
									
									</span>

								</p>

								<div id="listContainer" class="clear-fix block box-center likeContainer">
